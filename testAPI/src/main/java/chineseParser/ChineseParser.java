...
//Apply dependency parser 
...

		{
			...
			// MaxentTagger("C:\Java_Systems\Concept_Graph_QA\Java_Libraries\\stanford-postagger-2014-10-26\\models\\english-left3words-distsim.tagger");
...
//function to parse dat into subject verb object
	...
	public static void main(String... args) {
		Parse_Data("This is one last test!");
	}
	public static void Parse_Data(String sent)
...
//----------------
		...
		StringReader sr; // we need to re-read each line into its own reader because the tokenizer is
...

		{
			...
			words.add(tw.word());
			System.out.println("tw_word: " + tw.word());
			tags.add(tw.tag());
			System.out.println("tw_tag: " + tw.tag());
		}
