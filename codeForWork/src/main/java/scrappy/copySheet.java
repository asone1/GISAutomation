...
import codeForZk.Excel;

public class copySheet {

	public static void mergeExcelFiles(Excel excel1, Excel excel2) throws IOException {

		copySheets(excel1.assignSheet(0).getSheet(), excel2.assignSheet(0).getSheet());
